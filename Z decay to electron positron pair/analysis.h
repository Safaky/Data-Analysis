...
// Fri May  7 23:41:06 2021 by ROOT version 6.22/08
// from TTree LHEF/Analysis tree
// found on file: safak.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("safak.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("safak.root");
      }
