...
// Tue Jun 22 21:42:07 2021 by ROOT version 6.22/08
// from TTree Delphes/Analysis tree
// found on file: delphes-output-20k.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3745;
   static constexpr Int_t kMaxTrack = 165;
   static constexpr Int_t kMaxTower = 527;
   static constexpr Int_t kMaxEFlowTrack = 165;
   static constexpr Int_t kMaxEFlowPhoton = 306;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ZeEOutput.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ZeEOutput.root");
      }
