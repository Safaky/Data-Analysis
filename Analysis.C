...
void Analysis::Loop()
{
   ...
   if (fChain == 0) return;
    ...
    //1.ADIM:output çıktı dosyasını oluşturdum
        TFile *outputFile = new TFile("sınav-output.root","RECREATE");
        
        //2.ADIM:Histogramları oluşturucaz
        ...
        //Z kütlesi yeniden yapılandırma
